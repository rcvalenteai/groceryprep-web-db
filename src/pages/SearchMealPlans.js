...
class SearchMealPlans extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            items: [],
    ...
    fetchSearchMealPlans = async () => {
        ...
        let queryObj = {}
        //#TODO: Change API URL
        let get_recipes_url = "https://lkt9ygcr5g.execute-api.us-east-2.amazonaws.com/beta/mealplan";
        if (search) {
    ...
    handleSelectedTags(selected) {
        ...
        this.setState({
            ...
            function () { this.fetchSearchMealPlans() }
        )
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h2>Search Meal Plan Page</h2>
                <form onSubmit={e => this.handleSearch(e)}>
                    <label>
                        Search by Meal Plan Name:
...
export default SearchMealPlans;
